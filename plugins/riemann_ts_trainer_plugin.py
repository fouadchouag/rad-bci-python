...
class RiemannTSTrainerPlugin(BasePlugin):
    help = {
        'summary': 'Train a Tangent Space mapping (pyRiemann) from covariance matrices and labels.',
        'inputs': {
        ...
        'usage': 'Connect covariance matrices and their class labels. Click "Ajouter" to accumulate, then "Entraîner TS" to fit the tangent space. Outputs a fitted transform for RiemannTSApply.',
    }
