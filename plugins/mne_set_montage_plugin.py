...
class MNERawSetMontage(BasePlugin):
    help = {
        'summary': 'Apply a standard electrode montage to an MNE Raw object with tolerant channel name matching.',
        'inputs': {
        ...
        'parameters': [
            {'name': 'montage', 'type': 'str', 'default': 'standard_1020', 'desc': 'Standard montage name (e.g. "standard_1020", "standard_1005", "biosemi64", "easycap-M1"). Set via UI combo.'},
            {'name': 'auto', 'type': 'bool', 'default': True, 'desc': 'When True, montage is applied automatically on every incoming Raw.'},
        ],
        'gotchas': [
        ...
        'usage': 'Connect an MNE Raw node upstream. Select a montage from the dropdown; if auto is checked it applies on every data flow. Otherwise click "Appliquer" manually.',
    }
