...
class MNEICAPlugin(BasePlugin):
    help = help = {
        'summary': 'ICA decomposition with automatic EOG/ECG artifact detection and removal on Raw or Epochs.',
        'usage': 'Connect a Raw or Epochs object. The plugin fits ICA (with anti-freeze heuristics), detects artifact components, and optionally removes them.',
        'inputs': {
        ...
        'parameters': [
            {'name': 'n_components', 'type': 'int|None', 'default': None, 'desc': 'Number of ICA components (0 or None = auto)'},
            {'name': 'method', 'type': 'str', 'default': 'fastica', 'desc': 'ICA method: "fastica", "picard", or "infomax"'},
            {'name': 'decim', 'type': 'int|None', 'default': None, 'desc': 'Decimation factor for fitting (0 or None = auto)'},
            {'name': 'picks_eeg_only', 'type': 'bool', 'default': True, 'desc': 'Fit ICA on EEG channels only'},
            {'name': 'detect_eog', 'type': 'bool', 'default': True, 'desc': 'Auto-detect EOG artifact components'},
            {'name': 'detect_ecg', 'type': 'bool', 'default': False, 'desc': 'Auto-detect ECG artifact components'},
            {'name': 'apply', 'type': 'bool', 'default': True, 'desc': 'Apply ICA artifact removal to the output'},
        ],
        'gotchas': [
