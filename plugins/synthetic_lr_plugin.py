...
class SyntheticLRPlugin(BasePlugin):
    help = help = { 'gotchas': ['Generates a deterministic signal (RNG seed=42) for reproducibility.',
  ...
  'inputs': {},
  'outputs': {'raw': 'mne.io.RawArray — one-shot synthetic recording (on Generate)',
  ...
  'parameters': [ { 'default': 200.0,
                    'desc': 'Sampling rate',
                    'name': 'sfreq',
                    'type': 'float',
                    'unit': 'Hz'},
                  { 'default': 120,
                    'desc': 'Total signal duration',
                    'name': 'duration_s',
                    'type': 'int',
                    'unit': 's'},
                  { 'default': 2.0,
                    'desc': 'Block duration (Left/Right alternation)',
                    'name': 'block_s',
                    'type': 'float',
                    'unit': 's'},
                  { 'default': 2.0,
                    'desc': 'Streaming window size',
                    'name': 'win_s',
                    'type': 'float',
                    'unit': 's'},
                  { 'default': 50,
                    'desc': 'Overlap percentage',
                    'name': 'overlap',
                    'type': 'int',
                    'unit': '%'},
                  { 'default': True,
                    ...
                    'name': 'loop',
                    'type': 'bool'}],
  'summary': 'Generate synthetic Left/Right motor-imagery EEG with streaming support.',
  'usage': 'Click "Generate" for a one-shot Raw, or "Start Streaming" for real-time chunks. '
           'Connect segment to downstream processors.'}
