# Wrapper auto-généré pour triplers
import os
import subprocess
import json
...
class triplersPlugin(BasePlugin):
    name = "triplers"
    language = "external"
    category = "Custom"
    executable = r"custom_plugins/external_scripts/triple.exe"
    ...
    def execute(self, **kwargs):
        try:
            ...
            input_path = os.path.join(temp_dir, f"input_triplers.json")
            output_path = os.path.join(temp_dir, f"output_triplers.json")
