# Wrapper auto-généré pour quadrupletjs
import os
import subprocess
import json
...
class quadrupletjsPlugin(BasePlugin):
    name = "quadrupletjs"
    language = "external"
    category = "Custom"
    executable = r"custom_plugins/external_scripts/quadruplet.js"
    ...
    def execute(self, **kwargs):
        try:
            ...
            input_path = os.path.join(temp_dir, f"input_quadrupletjs.json")
            output_path = os.path.join(temp_dir, f"output_quadrupletjs.json")
