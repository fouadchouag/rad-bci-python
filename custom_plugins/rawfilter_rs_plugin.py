...
# Wrapper auto-généré (typed+UI) pour RawFilter_rs
...
class RawfilterRsPlugin(BasePlugin):
    name = "RawFilter_rs"
    language = "Rust"
    category = "Custom"
    executable = r"custom_plugins/external_scripts/eeg_filter_cli.exe"
    ...
    def execute(self, **kwargs):
        ...
        if result is None:
            ...
            in_path  = os.path.join("temp_io", "input_rawfilter_rs.json")
            out_path = os.path.join("temp_io", "output_rawfilter_rs.json")
